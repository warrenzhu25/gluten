 ...
 * https://github.com/GoogleCloudDataproc/spark-bigquery-connector/blob/71ff7f1e3b9bed4624688e85655863b294f955c1/bigquery-connector-common/src/main/java/com/google/cloud/bigquery/connector/common/ParallelArrowReader.java
 *
 * This file is an exact copy of Open Source Spark BQ Connector.
 * This is required to ensure that the Arrow vectors read from BQ Wire
 * Protocol is shaded correctly in the format that can be consumed by Gluten
 */
 ...
 *
 */
public class GlutenParallelArrowReader implements AutoCloseable {
  private static final Logger log = LoggerFactory.getLogger(GlutenParallelArrowReader.class);
   ...
   */
  public GlutenParallelArrowReader(
